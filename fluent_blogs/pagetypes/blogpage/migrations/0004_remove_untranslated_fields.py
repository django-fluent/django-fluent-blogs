...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlogPage.meta_description'
        db.delete_column('pagetype_blogpage_blogpage', 'meta_description')

        # Deleting field 'BlogPage.meta_title'
        db.delete_column('pagetype_blogpage_blogpage', 'meta_title')

        # Deleting field 'BlogPage.meta_keywords'
        db.delete_column('pagetype_blogpage_blogpage', 'meta_keywords')


    def backwards(self, orm):
        # Adding field 'BlogPage.meta_description'
        db.add_column('pagetype_blogpage_blogpage', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlogPage.meta_title'
        db.add_column('pagetype_blogpage_blogpage', 'meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlogPage.meta_keywords'
        db.add_column('pagetype_blogpage_blogpage', 'meta_keywords',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'blogpage.blogpage': {
            'Meta': {'ordering': "('tree_id', 'lft')", 'object_name': 'BlogPage', 'db_table': "'pagetype_blogpage_blogpage'", '_ormbases': ['fluent_pages.HtmlPage']},
