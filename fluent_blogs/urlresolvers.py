...
def blog_reverse(viewname, args=None, kwargs=None, current_page=None, current_app='fluent_blogs'):
    """
    ...
    """
    if _HAS_FLUENT_PAGES:
        return mixed_reverse(viewname, args=args, kwargs=kwargs, current_page=current_page)
    else:
