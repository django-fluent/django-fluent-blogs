...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry_Translation.slug'
        db.alter_column(u'fluent_blogs_entry_translation', 'slug', self.gf('slug_preview.models.SlugPreviewField')(max_length=50))

        # Changing field 'Entry_Translation.intro'
        db.alter_column(u'fluent_blogs_entry_translation', 'intro', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Entry_Translation.slug'
        db.alter_column(u'fluent_blogs_entry_translation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Entry_Translation.intro'
        db.alter_column(u'fluent_blogs_entry_translation', 'intro', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        'fluent_blogs.entry_translation': {
            ...
            'slug': ('slug_preview.models.SlugPreviewField', [], {'max_length': '50'}),
